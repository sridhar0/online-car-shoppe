		...
		<c:if test="${!isAdminClickedManageCategoryEdit=='true'}">
				...
				<div id="CreateCategory">
					...
					<form class="form-horizontal" action="manage-category-add">
						<div class="form-group">
							<label class="control-label col-sm-3" for="cId">Model Id:</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="cId" placeholder="Enter Model Id" name="cId" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="cName">Model Name:</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="cName" placeholder="Enter Model Name" name="cName" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="cDescription">CarModel Description:</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="cDescription" placeholder="Enter CarModel Description" name="cDescription" required>
							</div>
						</div>
